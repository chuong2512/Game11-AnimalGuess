...
public class IAPKey
{
    public const string PACK1 = "animal_guess_pack_1";
    public const string PACK2 = "animal_guess_pack_2";
    public const string PACK3 = "animal_guess_pack_3";
    public const string PACK4 = "animal_guess_pack_4";
    public const string PACK5 = "animal_guess_pack_5";
    public const string PACK6 = "animal_guess_pack_6";

    public const string PACK1_REGISTER = "animal_guess_pack_register_1";
    public const string PACK2_REGISTER = "animal_guess_pack_register_2";
    public const string PACK3_REGISTER = "animal_guess_pack_register_3";
    public const string PACK4_REGISTER = "animal_guess_pack_register_4";
    public const string PACK5_REGISTER = "animal_guess_pack_register_5";
}
