...
public class MainGameManager : MonoBehaviour
{
    ...
    public int index;
    public static MainGameManager main;
    public string word;
    ...
    public void ResetGam()
    {
        try
        {
            ...
            CurrentCoins = 25;
            hintCount = 0;
            FakeUIManager.Instance.count = 0;
            FakeUIManager.Instance.twtCount = 0;
    ...
    public static MainGameManager Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = GameObject.FindObjectOfType<MainGameManager>();
            }
